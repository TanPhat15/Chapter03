...
namespace SelectionStatements
{
    ...
    class PatternMatchingIfExample
    {
        public static void Run()
        {
    ...
    class PatternMatchingSwitchExample
    {
        public static void Run()
        {
            ...
            var animals = new Animal?[]
            {
                new Cat
                {
                    Name = "Karen", Born = new(year: 2022, month: 8,
                        day: 23),
                ...
                new Cat
                {
                    Name = "Mufasa", Born = new(year: 1994, month: 6,
                        day: 12)
                },
                new Spider
                {
                    Name = "Sid Vicious", Born = DateTime.Today,
                    IsPoisonous = true
                },
    ...
    class Program
    {
        ...
        {
            IfStatementExample.Run();
            PatternMatchingIfExample.Run();
            SwitchStatementExample.Run();
            PatternMatchingSwitchExample.Run();
        }
    }
